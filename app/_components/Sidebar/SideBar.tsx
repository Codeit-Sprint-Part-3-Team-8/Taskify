...
export default function SideBar() {
  ...
  return (
    <div className="fixed left-0 top-0 z-30 flex h-dvh w-16 flex-col gap-10 border border-r-gray-D9D9D9 bg-white px-3 py-5 tablet:w-40 tablet:gap-14 pc:w-72 pc:px-2">
      <Link
