      ...
      <div className="flex gap-4">
        ...
        <div className="flex flex-col">
          <div className="mb-2 flex items-center gap-2">
            <span className="text-[0.875rem] font-semibold">{nickname}</span>
            <span className="text-[0.75rem] font-normal text-gray-787486">
          ...
          {isEditing ? (
            ...
            <div className="mb-1 text-[0.875rem] font-normal">{content}</div>
          )}
