    ...
    <SortableContext id={id} items={items} strategy={rectSortingStrategy}>
      <div className="px-3 py-4 mobile:w-full pc:max-w-[384px]">
        <div className="border-b-2 pb-2 tablet:pb-6 pc:border-none">
          ...
          <ul
            ref={setNodeRef}
            className="tablet:scrollbar-hidden grid w-full grid-flow-col rounded-lg px-3 py-4 pb-8 mobile:gap-8 mobile:overflow-x-auto tablet:max-h-[220px] tablet:grid-flow-row tablet:gap-4 tablet:overflow-y-auto pc:h-full pc:max-h-full pc:gap-4"
          >
            {items.map((item) => (
